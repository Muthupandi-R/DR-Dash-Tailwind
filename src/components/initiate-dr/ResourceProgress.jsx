...
const ResourceProgress = ({ row, progressData }) => {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Information icon */}
        <ServerCog className="w-4 h-4 text-yellow-600 relative z-10 animate-spin-slow" />
      </button>
        ...
        createPortal(
          ...
          >
            ...
            <h3 className="text-base font-semibold mb-2 text-sm text-gray-800">
              ...
              <span className="text-gray-500">({statusData.provider})</span>
            </h3>
              ...
              <ul className="space-y-3">
                ...
                ${isCompleted ? "bg-green-500" : "bg-gray-200"}`}
                      ...
                      <div className="flex-1 text-xs">
                        <p className="text-gray-800 font-medium">{step.name}</p>

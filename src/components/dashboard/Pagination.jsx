      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="px-2 py-1 text-xs border bg-primary-50 border-primary-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent flex items-center gap-1 min-w-[50px] justify-between"
          >
            <span>{pageSize}</span>
            <FiChevronDown
          ...
          {isDropdownOpen && (
            <ul
              className={`absolute left-0 bg-white border border-primary-300 rounded-md shadow-lg z-10 min-w-[50px] ${
                dropdownPosition === "top"
                  ? "bottom-full mb-1"
                  : "top-full mt-1"
              }`}

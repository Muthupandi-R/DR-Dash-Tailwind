  ...
  return (
    <div className="grid gap-4 w-100">
      ...
      >
        ...
        <path
          d="M110.158 58.4715H13.6429V36.9888C13.6429 32.749 17.0749 29.317 21.3147 29.317H37.2887C39.8991 29.317 42.3233 30.6422 43.7404 32.8274L46.3435 36.8531C47.5643 38.765 49.6719 39.917 51.9419 39.917H102.986C107.226 39.917 110.658 43.349 110.658 47.5888V57.9715V58.4715H110.158Z"
          fill="#EEF2FF"
          stroke="#A5B4FC"
        />
        <path
          ...
          fill="#A5B4FC"
        />
        <circle cx="35.0715" cy="24.5715" r="1.07143" fill="#4F46E5" />
        <circle cx="28.6429" cy="24.5715" r="1.07143" fill="#4F46E5" />
        <circle cx="22.2143" cy="24.5715" r="1.07143" fill="#4F46E5" />
        <path
          d="M112.363 95.459L121.541 57.5077L112.363 95.459C111.119 100.551 106.571 104.14 101.323 104.14H21.8766C16.6416 104.14 12.0808 100.551 10.8498 95.4592L1.65901 57.507C0.0470794 50.8383 5.09094 44.4286 11.9426 44.4286H111.257C118.108 44.4286 123.166 50.8371 121.541 57.5069L112.363 95.459Z"
          fill="white"
          stroke="#E5E7EB"
        />
        <path
      ...
      <div>
        <h2 className="text-center text-black text-base font-semibold leading-relaxed pb-1">
          There’s no resource here
        </h2>
        <p className="text-center text-black text-sm font-normal leading-snug pb-4">
          Try adjusting your filters such as <br />
          resource names or project names to see available results.
        </p>
